...
def market_page():
    ...
    if request.method == 'POST':  # This is pretty much equal to validate_on_submit()
        # Purchase item logic
        purchase_item = request.form.get('purchase_item')  # We take purchase_item from the items_modals, the name
        ...
        if s_item_object:
            if current_user.can_sell(s_item_object):
                ...
                flash(f'Something went wrong selling {s_item_object.name}',
                      category='danger')
